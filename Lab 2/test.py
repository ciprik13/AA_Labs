...
if __name__ == '__main__':
    ...
    print_single_algorithm("SelectionSort", time_values)
    print(pretty_table)
    ...
    temp = list(time_values.keys()).index("Sorted Ascending 1M")
    res = values[:temp]
    plot_graph("SelectionSort", sizes, res)

    values = list(time_values_short.values())
    plot_graph("SelectionSort", small_sizes, values)

    all_values["SelectionSort"] = list(time_values.values())
